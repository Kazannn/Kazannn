...
* SQL for analytics and application support
* IT support fundamentals, including DNS, VPN, Microsoft 365, Active Directory concepts and ticketing workflows
* GitHub Actions and CI/CD basics
* AI agent workflows and RAG evaluation
